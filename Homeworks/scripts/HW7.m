...
%% Q1.d
tau = 0;
[t,res] = ode45(@(t,x) free_swing(t,x,m,g,r,tau),[0 5],[0.3; 0]);
figure;
plot(t,res(:,1));
...
[t,res] = ode45(@(t,x) controller1i(t,x,m,g,r,alph,bet,theta_d),[0 10],[0.3*pi; 0]);
figure;
plot(t,res(:,1));
title('Angular Position');
figure;
...
[t,res] = ode45(@(t,x) controller2a(t,x,m,g,r,alph,bet,theta_d),[0 10],[0.3*pi; 0]);
figure;
plot(t,res(:,1));
title('Angular Position');
figure;
