...
def main():
    ...
    goal.request.start_state.joint_state.position = [float(raw_input("head_pan start")), float(raw_input("left_s0 start")), \
    float(raw_input("left_s1 start")), float(raw_input("left_e0 start")), float(raw_input("left_e1 start")), float(raw_input("left_w0 start")),\
    float(raw_input("left_w1 start")), float(raw_input("left_w2 start")), float(raw_input("right_s0 start")), \
    float(raw_input("right_s1 start")), float(raw_input("right_e0 start")), float(raw_input("right_e1 start")), float(raw_input("right_w0 start")), \
    float(raw_input("right_w1 start")), float(raw_input("right_w2 start"))]
    ...
    target_joint_angles = [float(raw_input("head_pan finish")), float(raw_input("left_s0 finish")), \
    float(raw_input("left_s1 finish")), float(raw_input("left_e0 finish")), float(raw_input("left_e1 finish")), float(raw_input("left_w0 finish")),\
    float(raw_input("left_w1 finish")), float(raw_input("left_w2 finish")), float(raw_input("right_s0 finish")), \
    float(raw_input("right_s1 finish")), float(raw_input("right_e0 finish")), float(raw_input("right_e1 finish")), float(raw_input("right_w0 finish")), \
    float(raw_input("right_w1 finish")), float(raw_input("right_w2 finish"))]
    print("Goal joint states")
